...
public class Envoyer.Controllers.Database : Object {
    ...
    public Gee.Collection <Folder> get_folders_for_identity (string identity) {
        ...
        while (data_model_iter.move_next ()) {
            ...
            folder_struct.highest_mod_seq = 0; //@TODO
    ...
    public void set_threads_for_folder (Gee.Collection <ConversationThread> threads, Folder folder) {
        ...
        foreach (var thread in threads) {
            foreach (var current_message in thread.messages_list) {
