namespace MailCoreInterface.Imap {
    ...
    public async Gee.Collection<Envoyer.Models.Message> fetch_messages (void* session, string folder, uint starting_uid_value, uint end_uid_value, bool flags_only);
