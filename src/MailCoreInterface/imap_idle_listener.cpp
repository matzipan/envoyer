...
private:
 ...
 extern "C" void mail_core_interface_imap_idle_listener (mailcore::IMAPAsyncSession* session, gchar* folder_path, guint last_known_id, GAsyncReadyCallback callback, void* user_data) {
