...
public class Envoyer.Models.Sidebar.UnifiedFolderParent : IFolder, Basalt.Widgets.SidebarExpandableRowModel  {
    public Gee.Collection <UnifiedFolderChild> folder_children {
        owned get {
            return (Gee.Collection <UnifiedFolderChild>) children.full_list;
        }
    }
    ...
    public Gee.Collection <ConversationThread> threads_list {
        owned get {
